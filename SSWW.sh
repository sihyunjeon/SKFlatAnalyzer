...
#python python/SKFlat.py -a SSWW -e 2017 -l submitList/signals_M1500.txt -n 50 --userflags jcln_inv,fatjet_veto --batchname auto &
...
#python python/SKFlat.py -a SSWW -e 2018 -l submitList/signals_M1500.txt -n 50 --userflags jcln_inv,fatjet_veto --batchname auto &
